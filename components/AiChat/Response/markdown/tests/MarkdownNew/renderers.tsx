...
import { CustomTable, CustomTableHead, CustomTableBody, CustomTableRow, CustomTableCell, CustomTableHeaderCell } from '@/components/AiChat/Response/markdown/CustomTable';
