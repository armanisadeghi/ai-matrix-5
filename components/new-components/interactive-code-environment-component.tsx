import { Box, Button, Group, Loader, Select, Tabs, Text, useMantineColorScheme } from "@mantine/core";
import React, { useEffect, useState } from "react";
import AceEditor, { diff as DiffEditor, split as SplitEditor } from "react-ace";
...
const InteractiveCodeEnvironment: React.FC<InteractiveCodeEnvironmentProps> = ({
    ...
    const renderEditor = () => {
        ...
        switch (editorMode) {
            ...
            default:
                return <AceEditor value={Array.isArray(code) ? code[0] : code} {...commonProps} />;
        }
    };
