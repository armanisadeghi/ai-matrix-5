...
export const Textarea = forwardRef<HTMLTextAreaElement, TextareaProps>(
    ({ label, placeholder = "", value = "", onChange, className = "", icon, size = "md", rows = 3, ...props }, ref) => {
        const baseClass =
            "border border-neutral-600 bg-neutral-800 rounded-md focus:ring-2 placeholder:text-sm ease-in-out focus:ring-2 focus:ring-neutral-400 focus:border-neutral-300 outline-none transition duration-150";
