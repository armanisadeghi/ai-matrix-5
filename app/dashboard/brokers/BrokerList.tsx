                        ...
                        <React.Suspense fallback={<Loading />}>
                            {brokers.map((broker) => (
                                <Table.Tr key={broker.id}>
                                    ...
                                    <TableTd><TruncatedTooltip text={broker.name || ''} maxWidth={200} /></TableTd>
                                    <TableTd><TruncatedTooltip text={broker.data_type || ''} maxWidth={150} /></TableTd>
                                    <TableTd><TruncatedTooltip text={broker.component.type || ''} maxWidth={150} /></TableTd>
                                    <TableTd><TruncatedTooltip text={broker.default_value as string || ''} maxWidth={100} /></TableTd>
                                    <TableTd><TruncatedTooltip text={broker.category || ''} maxWidth={150} /></TableTd>
                                    <TableTd><TruncatedTooltip text={broker.official_name || ''} maxWidth={200} /></TableTd>
                                    <TableTd><TruncatedTooltip text={broker.description || ''} maxWidth={300} /></TableTd>
                                    <TableTd>
                                        <Group wrap="nowrap">
