...
import React, { CSSProperties, ReactNode, useState, useRef, useMemo, useCallback } from 'react';
...
const VerticalSplitter: React.FC<VerticalSplitterProps> = React.memo(({ children, initialSizes, expandToMin = true }) => {
    ...
    const createGutter = useCallback((index: number, direction: string) => {
