...
export const CustomTableRow: React.FC<CustomTableProps> = ({ children }) => (
    <tr className="m_4e7aa4fd mantine-Table-tr" data-striped="odd" data-hover="true">
        {children}
    </tr>
)

export const CustomTableCell: React.FC<CustomTableProps> = ({ children }) => (
    <td className="m_4e7aa4ef mantine-Table-td" data-with-column-border="true">
        {children}
    </td>
)

export const CustomTableHeaderCell: React.FC<CustomTableProps> = ({ children }) => (
    <th className="m_4e7aa4f3 mantine-Table-th" data-with-column-border="true">
        {children}
    </th>
)
