            ...
            case 'Input':
                return (
                    <TextInput
                        ...
                        onChange={(value) =>
                            handleDefaultValueChange
                                ? handleDefaultValueChange(value.target.value)
                                : currentData.setFieldValue('value', value.target.value)
                        }
                    />
                )
            case 'Textarea':
                    ...
                    <BrokerSlider
                        ...
                        onChange={(value) =>
                            handleDefaultValueChange
                                ...
                                : currentData.setFieldValue('value', value)
                        }
                    />
                )
            case 'YesNo':
            ...
            case 'Checkbox':
                return (
                    <Checkbox
                        ...
                        onChange={(value) =>
                            handleDefaultValueChange
                                ? handleDefaultValueChange(value.target.checked)
                                : currentData.setFieldValue('value', value.target.checked)
                        }
                    />
                )
            case 'CheckboxGroup':
                    ...
                    <Select
                        ...
                        onChange={(value) =>
                            handleDefaultValueChange
                                ...
                                : currentData.setFieldValue('value', value as string)
                        }
                    />
                )
            case 'Json':
                    ...
                    <FileInput
                        ...
                        onChange={(value: File | null) =>
                            handleDefaultValueChange
                                ...
                                : currentData.setFieldValue('value', value as File)
                        }
                    />
                )
            case 'AttachmentsURL':
