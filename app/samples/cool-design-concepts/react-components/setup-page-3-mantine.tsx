...
const Sidebar = () => (
    <Stack>
        ...
        <Text size="xl" fw={600}>Get started</Text>
    ...
    return (
        <Paper p="md" style={{ opacity: isActive ? 1 : 0.5, pointerEvents: isActive ? 'auto' : 'none' }}>
            <Group justify="space-between" mb="xs">
                <Text tt="uppercase" fw={700} size="xs">{title}</Text>
            ...
            <Stack style={{ flex: 1 }}>
                <SetupStep title="Create repository" isActive={true}>
                    <Stack>
                        ...
                        <Box>
                            <Text fw={500} size="sm" mb={4}>Organization</Text>
                        ...
                        />
                        <Switch label="Create private Repository" />
                    ...
                    <Stack>
                        ...
                        <Paper p="sm" withBorder>
                            <Group justify="space-between">
                                <Text size="sm">Open it in your favorite code editor:</Text>
                                <Group>
                        ...
                        <Paper p="sm" withBorder>
                            <Group justify="space-between">
                                <Text size="sm">Or directly on GitHub:</Text>
                ...
                <SetupStep title="Deploy" isActive={false}>
                    <Stack>
                        <Text size="sm">Preparing repository.</Text>
                        <Paper p="sm" withBorder>
                            <Stack>
                                <Group>
                                    <IconCheck size={16} />
                                    <Text size="sm">GitHub commit</Text>
                                </Group>
                                <Group>
                                    <IconCode size={16} />
                                    <Text size="sm">Building logs</Text>
                                </Group>
                                <Group>
                                    <IconCode size={16} />
                                    <Text size="sm">Deploying application</Text>
                                </Group>
                            </Stack>
                        </Paper>
                    </Stack>
