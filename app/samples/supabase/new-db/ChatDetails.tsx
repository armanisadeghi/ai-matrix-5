import { activeChatIdAtom, chatMessagesAtomFamily, chatMessagesSelectorFamily } from "@/state/aiAtoms/aiChatAtoms";
...
const ChatDetails = () => {
    ...
    const chatMessages = useRecoilValue(chatMessagesSelectorFamily(activeChatId ?? "")) ?? [];
    ...
    return (
        <div>
            ...
            <p>
                <strong>Chat ID:</strong> {chatDetails.chatId}
            </p>
            <p>
                <strong>User ID:</strong> {chatDetails.userId}
            </p>
            <p>
                <strong>Created At:</strong> {chatDetails.createdAt}
            </p>
            <p>
                <strong>Last Edited:</strong> {chatDetails.lastEdited}
            </p>
            <p>
                <strong>Metadata:</strong> {JSON.stringify(chatDetails.metadata)}
            </p>
            <div>
