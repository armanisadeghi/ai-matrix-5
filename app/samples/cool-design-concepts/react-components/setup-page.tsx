...
import { ChevronLeft, MessageSquare, Calendar, ChevronDown, Github, Check, Code } from 'lucide-react';

const Sidebar = () => (
    <div className="sm:w-1/3 space-y-8">
...
const SetupPageLayout = () => (
    <div className="min-h-screen text-white bg-gray-900">
        <div className="min-h-screen text-white bg-gray-900">
            <div className="r-starter">
                <div className="r-container sm:flex gap-4 space-y-8">
                    <Sidebar />
