...
import { componentSelector, selectedBroker } from "@/context/atoms/brokerAtoms";
...
const BrokerComponent: React.FC<BrokerComponentProps> = ({ type, id, handleDefaultValueChange }) => {
    ...
    const { displayName } = (currentBroker as Broker | any) || currentComponent || "test";
    const { tooltip, description } = (currentComponent as Component | any) || (currentBroker as Broker | any) || "test";
    const {
        withAsterisk,
        maxRows,
        resize,
    ...
    if (type) {
        switch (type) {
            case "Input":
                return (
                    <Tooltip label={tooltip || "Input"} withArrow={withArrow} position={position}>
                        <TextInput
                            ...
                            onChange={(value) => handleDefaultValueChange(value.target.value)}
                        />
                    </Tooltip>
                );
            case "NumberInput":
                return (
                    <Tooltip label={tooltip || "Number Input"} withArrow={withArrow} position={position}>
                        <NumberInput
                            withAsterisk={withAsterisk || required}
                            error={validation}
            ...
            case "Textarea":
                return (
                    <Tooltip label={tooltip || "Textarea"} withArrow={withArrow} position={position}>
                        <Textarea
            ...
            case "Slider":
                return (
                    <Tooltip label={tooltip || "Slider"} withArrow={withArrow} position={position}>
                        <BrokerSlider
                            defaultValue={defaultValue as number}
            ...
            case "YesNo":
                return (
                    <Tooltip label={tooltip || "Yes/No"} withArrow={withArrow} position={position}>
                        <BrokerRadioGroup
                            defaultValue={defaultValue as string}
            ...
            case "Checkbox":
                return (
                    <Tooltip label={tooltip || "Checkbox"} withArrow={withArrow} position={position}>
                        <Checkbox
            ...
            case "CheckboxGroup":
                return (
                    <Tooltip label={tooltip || "Checkbox Group"} withArrow={withArrow} position={position}>
                        <Checkbox.Group
                            defaultValue={defaultValue as string[]}
                        ...
                        >
                            <Group p="xs">
                                {options &&
                                    options.map((option) => <Checkbox key={option} value={option} label={option} />)}
                            </Group>
                        </Checkbox.Group>
                    </Tooltip>
                );
            case "CheckboxGroupWithOther":
                return (
                    <>
                        <Tooltip
                            label={tooltip || "Checkbox Group With Other Option"}
                            withArrow={withArrow}
                            position={position}
                        >
                            <Checkbox.Group
            ...
            case "Switch":
                return (
                    <Tooltip label={tooltip || "Switch"} withArrow={withArrow} position={position}>
                        <Switch
                            defaultValue={defaultValue as string}
            ...
            case "SwitchGroup":
                return (
                    <Tooltip label={tooltip || "Switch Group"} withArrow={withArrow} position={position}>
                        <Switch.Group
                            defaultValue={defaultValue as string[]}
                        ...
                        >
                            <Group mt="xs">
                                {options &&
                                    options.map((option) => <Switch key={option} value={option} label={option} />)}
                            </Group>
                        </Switch.Group>
                    </Tooltip>
                );
            case "SwitchGroupWithOther":
                return (
                    <>
                        <Tooltip
                            label={tooltip || "Switch Group With Other Option"}
                            withArrow={withArrow}
                            position={position}
                        >
                            <Switch.Group
                            ...
                            >
                                <Group mt="xs">
                                    ...
                                    <Switch
                                        ...
                                        label="Other"
                                        checked={otherSwitch}
                                        onChange={() => setOtherSwitch(!otherSwitch)}
                                    />
                                </Group>
                            </Switch.Group>
                        </Tooltip>
                        {otherSwitch && (
                            <TextInput onChange={(value) => handleDefaultValueChange(value.target.value)} />
                        )}
                    </>
                );
            case "Select":
                return (
                    <Tooltip label={tooltip || "Select"} withArrow={withArrow} position={position}>
                        <Select
            ...
            case "SelectWithOther":
                return (
                    <>
                        <Tooltip
                            label={tooltip || "Select With Other Option"}
                            withArrow={withArrow}
                            position={position}
                        >
                            <Select
            ...
            case "Json":
                return (
                    <Tooltip label={tooltip || "Json"} withArrow={withArrow} position={position}>
                        <JsonInput
            ...
            case "AttachmentsVideo":
                return (
                    <Tooltip label={tooltip || "Upload Video"} withArrow={withArrow} position={position}>
                        <FileInput
                            label={label || displayName || "Upload Video"}
                            description={description}
                            placeholder={placeholder}
                            required={required || withAsterisk}
                            size={size}
            ...
            case "AttachmentsAudio":
                return (
                    <Tooltip label={tooltip || "Upload Audio"} withArrow={withArrow} position={position}>
                        <FileInput
            ...
            case "AttachmentsFile":
                return (
                    <Tooltip label={tooltip || "Upload File"} withArrow={withArrow} position={position}>
                        <FileInput
            ...
            case "AttachmentsURL":
                return (
                    <Tooltip label={tooltip || "Upload URL"} withArrow={withArrow} position={position}>
                        <TextInput
            ...
            case "Image":
                return (
                    <Tooltip label={tooltip || "Upload Image"} withArrow={withArrow} position={position}>
                        <Image
                            src={src}
