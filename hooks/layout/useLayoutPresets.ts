...
import {
    ...
    showFooterToggle, presetTypeAtom, customValuesAtom, overrideFlagAtom
} from "@/state/layoutAtoms";
import { CustomPresets, getLayoutPresets } from "./layoutPresets";
import { PresetType, PresetMethod, PresetValue, LayoutPreset, ModulePreset, PagePreset, ComponentPreset } from "@/types/layout";
...
const useLayoutPresets = () => {
    ...
    const setPreset = (preset: { header: PresetValue, leftSidebar: PresetValue, rightSidebar: PresetValue, footer: PresetValue, toggles?: { header: boolean, leftSidebar: boolean, rightSidebar: boolean, footer: boolean } }) => {
