...
const AtomTesterPage: React.FC = () => {
    ...
    const items: StateItem[] = [
        ...
        { type: "atomFamily", name: "messagesAtomFamily", atom: chatMessagesAtomFamily, viewType: "json" },
        { type: "selector", name: "chatSummariesSelector", selector: chatMessagesSelector, viewType: "json" },
        ...
        { type: "atomFamily", name: "liveChatsAtomFamily", atom: chatMessagesAtomFamily, viewType: "json" },
    ...
    return (
        <>
            <AmeJsonInput value={messagesString} readOnly autosize label="Items" />
            <Stack gap="md">
                <Select
                    label="Choose Layout"
                    value={layoutType}
