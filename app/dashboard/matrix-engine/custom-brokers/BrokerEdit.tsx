        ...
        <Grid>
                ...
                <Fieldset legend="Add properties">
                    {currentBrokerAtomValue.component.type === 'Slider' && (
                        <>
                            <Switch
                                label="Marks"
                                onChange={(e) => handleChange('isMarks', e.target.checked)}
                            />
                            <Space h="sm" />
                        </>
                    )}
                    ...
                    <BrokerSizeSlider
                        label="Size"
                        onChange={(e) => handleChange('size', e as any)}
                    />
                </Fieldset>
                <Space h="sm" />
            ...
            <Grid.Col span={{ base: 12, md: 6 }}>
                <Fieldset legend="Component" radius="md">
                    <BrokerComponent
                        currentComponent={currentBrokerAtomValue.component}
                        type={currentBrokerAtomValue.component.type}
                    />
                </Fieldset>
            </Grid.Col>
        </Grid>
