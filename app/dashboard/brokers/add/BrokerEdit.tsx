            ...
            <Grid>
                <Grid.Col span={{ base: 12, md: 4 }}>
                    <Flex justify="flex-start" wrap={'wrap'} align="center" w="100%" gap={20}>
                        ...
                        <Switch
                            size="xs"
                            label="With Asterisk"
                            onChange={(e) => handleChange('withAsterisk', e.target.checked)}
                        />
                        <Switch
                            size="xs"
                            label="Autosize"
                        ...
                        <Switch
                            ...
                            onChange={(e) => handleChange('submitOnEnter', e.target.checked)}
                        />
                        <Switch
                            size="xs"
                            label="Expandable"
                    ...
                    <Switch
                        size="xs"
                        label="With Arrow"
                        onChange={(e) => handleChange('withArrow', e.target.checked)}
                    />
                    <Space h="sm" />
                    <TextInput
                        size="xs"
                    ...
                    <NumberInput
                        ...
                        label="Min Rows"
                        onChange={(e) => handleChange('minRows', e)}
                    />
                    <Space h="sm" />
                    <NumberInput
                        size="xs"
                        ...
                        label="Max Rows"
                        onChange={(e) => handleChange('maxRows', e)}
                    />
                    <Space h="sm" />
                    ...
                    <TextInput
                        size="xs"
                        label="Dependencies"
                        description="Separate dependencies with commas"
                ...
                <Grid.Col span={{ base: 12, md: 4 }}>
                    ...
                    <Switch
                        size="xs"
                        label="Validation"
                        onChange={(e) => setValidation(e.target.checked ? 'required' : null)}
                    />
                    <Space h="xs" />
                    {validation === 'required' && (
                        <TextInput
