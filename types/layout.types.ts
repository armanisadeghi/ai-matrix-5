...
export type LayoutPreset = 'standard' | 'focusLeft' | 'focusRight' | 'minimalNav' | 'noSidebars' | 'iconsFullAside' | 'iconsNoAside' |'iconsCompactAside' | 'balanced' | 'onlyHeader' | 'standardWithFooter';
export type ModulePreset = 'dashboard' | 'intelligence' | 'public' | 'samples' | 'matrixApps';
export type PagePreset = 'chat' | 'settings' | 'profile' | 'notifications' | 'help' | 'about' | 'register' | 'notFound' | 'error' | 'centerContent';
