...
type ISizes = [number] | [number, number] | [number, number, number];
...
const EnhancedResizableLayout: React.FC<Props> = ({
    ...
    return (
        <div ref={containerRef} className={`${styles.container} ${direction === "vertical" ? styles.vertical : ""}`}>
            <div className={styles.panel}>{children[0]}</div>
            <div ref={resizerRef} className={styles.resizer} onMouseDown={startResize} onTouchStart={startResize} />
