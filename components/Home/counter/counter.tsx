        ...
        <div className={classes.girdItem}>
            ...
            <div className={`${classes.itemContent}`}>
                <Title
                    mb={15}
                    order={3}
                    className={`${classes.innerTitle} animate-on-scroll`}
                    ref={(el: HTMLDivElement | null) => elementsRef.current.push(el)}
                >
                    {title}
                </Title>
                <Text
                    className={`${classes.innerDesc} animate-on-scroll`}
                    ref={(el: HTMLDivElement | null) => elementsRef.current.push(el)}
                >
                    {description}
                </Text>
                    ...
                    <Grid justify="center" align="center" className={classes.row}>
                        <Grid.Col span={{ xs: 12, sm: 5 }} className={classes.columnContentFirst}>
                            ...
                            <Text
                                ...
                                ref={(el: HTMLDivElement | null) => elementsRef.current.push(el)}
                            >
                                Bid teams spend 80% of their time in the drafting stage with little scope to edit,
                                enhance and elevate the quality of their work. Our world class engineers have dedicated
                                over 50,000 hours to building software that allows you to spend more time on the
                                activities that get you to a winning bid.
                            </Text>
                        </Grid.Col>
