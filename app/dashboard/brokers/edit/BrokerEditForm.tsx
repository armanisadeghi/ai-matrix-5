...
export const BrokerEditForm = ({ id }: { id: string }) => {
    ...
    const handleEditBroker = () => {
        try {
            brokerManager.updateBroker({
                ...currentData,
                dataType: typeof currentData.component.defaultValue,
            ...
            <Grid.Col span={{ base: 12, md: 6 }}>
                <Fieldset legend="Add properties">
                    <TextInput
                        label="Name"
                        onChange={(value) =>
                            setCurrentData({ ...currentData, name: value.target.value })
                        }
                    ...
                    <TextInput
                        ...
                        onChange={(value) =>
                            setCurrentData({ ...currentData, description: value.target.value })
                        }
