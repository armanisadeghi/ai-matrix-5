...
import styles from '@/app/trials/custom-splitter/enhanced-splitter/enhanced-resizable-layout.module.css';
...
const EnhancedResizableLayout: React.FC<Props> = (
    ...
    return (
        ...
        >
            <div className={styles.panel}>First Panel</div>
            <div
                ref={resizerRef}
            ...
            />
            <div className={styles.panel}>Second Panel</div>
        </div>
    );
};
