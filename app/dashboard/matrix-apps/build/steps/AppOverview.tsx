        ...
        <CustomCheckboxGroup
          ...
          checkboxes={[
            ...
            },
            {
              label: "My Company",
              value: "myCompany",
              tooltip: "Visible to employees within your organization.",
            },
            {
              label: "My Connections",
              value: "myConnections",
              tooltip:
                "Visible by other Matrix users with whom you have connections.",
            },
            {
              label: "Matrix Market Free",
              value: "matrixMarketFree",
              tooltip: "Free for all users to use.",
            },
            {
              label: "Matrix Market Paid",
              value: "matrixMarketPaid",
              tooltip: "All users can see it, but can only use it for a fee.",
            },
            {
              label: "Public",
              value: "public",
              tooltip:
                "Displayed publicly, if selected for a blog or other public view.",
            },
            {
              label: "Agency Companies",
              value: "agencyCompanies",
              tooltip: "Available to all companies within my Agency.",
            },
          ]}
        />
      </div>
